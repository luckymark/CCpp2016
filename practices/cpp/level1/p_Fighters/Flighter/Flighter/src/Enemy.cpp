...
void Enemy::shoot(Enemyshoot * enemyshoot[], int i,float x,float y, sf::Sound &shootSound, float multiple1)
{
	float shootspeed = 3;
	if (y < getY())
	{
	...
	if (this != NULL && this->gettimeNow() % sf::seconds(3 * multiple1) < sf::seconds(0.009))
	{
